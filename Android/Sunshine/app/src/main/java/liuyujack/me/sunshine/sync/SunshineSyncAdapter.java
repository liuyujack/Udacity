...
import liuyujack.me.sunshine.MainActivity;
import liuyujack.me.sunshine.R;
import liuyujack.me.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        Log.d(LOG_TAG, "Called onPerformSync");
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, "d0a13955cfbf8dc92bf587b6d00fda12")
                    .build();
    ...
    private void notifyWeather() {
        ...
        boolean displayNotification = prefs.getBoolean(displayNotificationsKey,
                Boolean.parseBoolean(context.getString(R.string.pref_enable_notifications_default)));

        if (displayNotification){
            String lastNotificationKey = context.getString(R.string.pref_location_default);
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS){
                ...
                if (cursor.moveToFirst()) {
                    ...
                    Log.d(LOG_TAG, "start to build the Notification");
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
        //We've created a new account
        SunshineSyncAdapter.configurePeriodSync(context,SYNC_INTERVAL,SYNC_FLEXTIME);

        //Without calling setSyncAutomatically, cant enable it
